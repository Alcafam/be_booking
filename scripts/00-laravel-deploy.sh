...
# php artisan migrate --path=/database/migrations/2025_03_21_195706_create_events_table.php
# php artisan migrate --path=/database/migrations/2025_03_21_195726_create_bookings_table.php
